...
> **Purpose:** Give this file to any AI agent, designer, or developer building branded work for **iswar.me** — presentations, social posts, subdomain apps, POCs, slide decks, PDFs, email headers, and marketing surfaces.
>
...
| This brand doc | `DESIGN.md` |

When the website and this file disagree on **branded** work, prefer **this file** + the **blog article** aesthetic. When implementing the main marketing site chrome specifically, defer to the repo CSS.
